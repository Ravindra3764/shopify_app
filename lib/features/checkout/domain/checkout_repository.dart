...
/// Guest checkout operations layered on top of the Storefront Cart API.
///
/// These attach buyer/delivery details to the same guest cart identified by
/// [Cart.id]; no customer token is involved. Each returns the updated [Cart]
/// (with recomputed cost + `deliveryGroups`).
abstract interface class CheckoutRepository {
  /// Attaches [email] and [address] to cart [cartId]. Shopify then computes
  /// tax and populates shipping options in `deliveryGroups`.
